...
from ..common import routing_pb2 as routing__pb2
...
def add_RoutingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'QueryOriginalStation': grpc.unary_unary_rpc_method_handler(
            ...
            'QueryNextStation': grpc.unary_unary_rpc_method_handler(
            ...
            'QueryRoutingChains': grpc.unary_unary_rpc_method_handler(
            ...
            'QueryNextRegion': grpc.unary_unary_rpc_method_handler(
...
class RoutingService(object):
    ...
    def QueryOriginalStation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/warebasic.RoutingService/QueryOriginalStation',
    ...
    def QueryNextStation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/warebasic.RoutingService/QueryNextStation',
    ...
    def QueryRoutingChains(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/warebasic.RoutingService/QueryRoutingChains',
    ...
    def QueryNextRegion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/warebasic.RoutingService/QueryNextRegion',
